package com.rahul.imgur.ui.adapters
...
import com.rahul.imgur.ui.utils.DateUtil
import com.rahul.imgur.ui.utils.NetworkState
import com.rahul.imgur.ui.utils.State
...
class ImagesListAdapter(
    var glideRequests: com.rahul.imgur.ui.utils.GlideRequests,
    var viewType :Int,
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            ...
            R.layout.images_row_list -> (holder as ImagesViewHolderList).bindTo(getItem(position))
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            R.layout.images_row_list -> ImagesViewHolderList(parent, glideRequests, clickCallback)
...
class ImagesViewHolder(
    ...
    fun bindTo(images: Images?) {
        ...
        if (images!!.title!=null){
            titlePost = images.title!!
        }

        if (images!!.description!=null){
            titlePost = images.description!!
        }

        itemView.txtTitle.text = titlePost
        itemView.txtDate.text = images?.datetime?.let { DateUtil.getDateLocal(it) }
    }
}

class ImagesViewHolderList(
    parent: ViewGroup,
    var glideRequests: com.rahul.imgur.ui.utils.GlideRequests,
    private val clickCallback: (image: Images) -> Unit
) :
    RecyclerView.ViewHolder(
        LayoutInflater.from(parent.context).inflate(
            R.layout.images_row_list, parent, false
        )
    ) {
    private var images: Images? = null
